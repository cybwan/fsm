...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in NamespacedServiceOrder) DeepCopyInto(out *NamespacedServiceOrder) {
	{
		in := &in
		*out = make(NamespacedServiceOrder, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespacedServiceOrder.
func (in NamespacedServiceOrder) DeepCopy() NamespacedServiceOrder {
	if in == nil {
		return nil
	}
	out := new(NamespacedServiceOrder)
	in.DeepCopyInto(out)
	return *out
}
