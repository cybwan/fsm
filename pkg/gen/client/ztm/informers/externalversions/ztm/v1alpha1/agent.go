...
import (
	...
	ztmv1alpha1 "github.com/flomesh-io/fsm/pkg/apis/ztm/v1alpha1"
	versioned "github.com/flomesh-io/fsm/pkg/gen/client/ztm/clientset/versioned"
	internalinterfaces "github.com/flomesh-io/fsm/pkg/gen/client/ztm/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/flomesh-io/fsm/pkg/gen/client/ztm/listers/ztm/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ZtmV1alpha1().Agents().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ZtmV1alpha1().Agents().Watch(context.TODO(), options)
			},
		},
		&ztmv1alpha1.Agent{},
		resyncPeriod,
...
func (f *agentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ztmv1alpha1.Agent{}, f.defaultInformer)
}
