...
func (c *FakeZookeeperConnectors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ZookeeperConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(zookeeperconnectorsResource, name), &v1alpha1.ZookeeperConnector{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeZookeeperConnectors) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ZookeeperConnectorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(zookeeperconnectorsResource, zookeeperconnectorsKind, opts), &v1alpha1.ZookeeperConnectorList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeZookeeperConnectors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchAction(zookeeperconnectorsResource, opts))
}
...
func (c *FakeZookeeperConnectors) Create(ctx context.Context, zookeeperConnector *v1alpha1.ZookeeperConnector, opts v1.CreateOptions) (result *v1alpha1.ZookeeperConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(zookeeperconnectorsResource, zookeeperConnector), &v1alpha1.ZookeeperConnector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ZookeeperConnector), err
...
func (c *FakeZookeeperConnectors) Update(ctx context.Context, zookeeperConnector *v1alpha1.ZookeeperConnector, opts v1.UpdateOptions) (result *v1alpha1.ZookeeperConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(zookeeperconnectorsResource, zookeeperConnector), &v1alpha1.ZookeeperConnector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ZookeeperConnector), err
...
func (c *FakeZookeeperConnectors) UpdateStatus(ctx context.Context, zookeeperConnector *v1alpha1.ZookeeperConnector, opts v1.UpdateOptions) (*v1alpha1.ZookeeperConnector, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(zookeeperconnectorsResource, "status", zookeeperConnector), &v1alpha1.ZookeeperConnector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ZookeeperConnector), err
...
func (c *FakeZookeeperConnectors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewRootDeleteCollectionAction(zookeeperconnectorsResource, listOpts)
...
func (c *FakeZookeeperConnectors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ZookeeperConnector, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(zookeeperconnectorsResource, name, pt, data, subresources...), &v1alpha1.ZookeeperConnector{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ZookeeperConnector), err
