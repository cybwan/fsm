...
type ConnectController interface {
	...
	GetServiceInstanceID(name, addr string, port MicroSvcPort, protocol MicroSvcProtocol) string
...
type ServiceInstanceIDFunc func(name, addr string, port MicroSvcPort, protocol MicroSvcProtocol) string
